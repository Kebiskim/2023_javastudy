...
public class Pw_Find_Window {
	...
	Pw_Find_VO pwVO = new Pw_Find_VO();
	...
	private void initialize() {
		...
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("윈도우 창 " + input_Id);
				System.out.println("윈도우 창 " + input_Pw);
				pwVO.setInput_Id(input_Id);
				pwVO.setInput_Pw(input_Pw);
				pwFind.pwFind();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pw_Find_Window window = new Pw_Find_Window();
