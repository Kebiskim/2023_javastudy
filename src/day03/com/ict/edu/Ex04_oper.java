...
public class Ex04_oper {
	public static void main(String[] args) {
		...
		result = (su1 <= 7) && (su2 >= 5); // AND는 false를 만나는 순간 결과가 false => 뒤에거 볼필요 X
		System.out.println(result);
		...
		result = ((su1 = su1 + 2) > su2 )  &&  (su1 == (su2 = su2 + 5 )) ; // 결과는 true (su1이 12가 되어서)
		...
		result = ((su1 = su1 + 2) < su2 )  &&  (su1 == (su2 = su2 + 5 )) ; // false 나오는순간 뒤에 계산 x
		System.out.println("결과는 : " + result);
		System.out.println("su1 : " + su1);
		System.out.println("su2 : " + su2);
		System.out.println("==========================");
