...
import javax.swing.JPanel;
	...
	// ActionEvent : 컴포넌트를 눌렀거나, 선택되었을 때 또는 Enter키를 눌렀을 때 발생하는 이벤트
	// ActionListener : actionPerformed() 라는 추상메서드를 가짐.
...
//			System.out.println("버튼을 눌렀네요");
			...
			// jb1이 지역변수이면 위 } 나올때 없어지므로,
			// ★ 이벤트 처리부터는, 컴포넌트는 모두 전역변수로 빼야 함!!! ★
			if (obj == jb1) {
