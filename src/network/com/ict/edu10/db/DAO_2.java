package network.com.ict.edu10.db;

import java.util.List;

import org.apache.ibatis.session.SqlSession;

import network.com.ict.edu10.db.DBService;
...
public class DAO_2 {
	// 실제 사용하는 클래스 : SqlSession
		...
		public static List<VO_2> getList(){
			List<VO_2> list = null;
		...
		public static boolean getIdChk(String custid) {
			...
			VO_2 vo = getSession().selectOne("idChk", custid);
			if(vo == null) {
				result = true;
			}
			return result;
